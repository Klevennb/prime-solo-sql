...
-- 3.The bank is giving a new customer bonus! How do you update all 
...
-- 5. How do you get the username and account balance of the 3 users with the highest
--  balances, sorted highest to lowest balance? NOTE: Research LIMIT
    SELECT * FROM "accounts" ORDER BY "account_balance" DESC LIMIT 3; 
-- 6. How do you get the username and account balance of the 3 users with 
-- the lowest balances, sorted lowest to highest balance?
...
-- 8. How do you add a new account?
    INSERT INTO accounts (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('user', 'mpls', 1, 2, 3);
...
-- 2. Grace closed her account.
    DELETE FROM "accounts" WHERE "name" = 'grace';
-- 3. Travis made a withdrawl of $20,000. What's their new balance? NOTE: Research RETURNING
    UPDATE "accounts" SET "account_balance" = "account_balance" - 20000, "transactions_completed"="transactions_completed"+1 WHERE "name" = 'travis' RETURNING "account_balance";
